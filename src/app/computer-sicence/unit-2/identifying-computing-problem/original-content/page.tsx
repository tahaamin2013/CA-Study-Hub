export default function ComputingProblems() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">2.2 Identifying a Computing Problem</h1>
      <p className="mb-4">
        In computer science, a problem is a challenge or situation that needs to be overcome using some action. In
        computer science, a computing problem is a problem that is solved step-by-step using computation. It can
        include any type of calculation such as arithmetical or logical. These problems usually have a well-defined
        input and some desired properties that output must be satisfied.
      </p>
      <h2 className="text-xl font-semibold mb-2">Following are some of the computing problems:</h2>
      ...
      <p className="mb-4">
        A decision problem occurs when a given input requires a binary response, either Yes or No. Responses may take
        various forms, such as true or false. Figure 2.1 visually illustrates a simple decision problem. In complex
        cases, answers extend beyond a straightforward Yes-or-No, involving multiple decision factors and criteria.
      </p>
      <h3 className="text-lg font-medium mb-2">The examples of simple decision problems are:</h3>
      <ul className="list-disc list-inside mb-4">
      ...
      <p className="mb-4">
        In science and engineering, many problems are solved using search. In such types of problems, we have a set of
        objects among which we search for the solution. For example, finding a path between two cities. Search problems
        are often represented using graphs, where we have nodes and each link connects two nodes. A node can be
      ...
      <ul className="list-disc list-inside mb-4">
        <li><strong>Initial State:</strong> Represents the node from where we need to start the search.</li>
        <li><strong>Operations:</strong> Represents the moves that transition from one node to another.</li>
        <li><strong>Goal:</strong> Defines the target or end condition.</li>
      </ul>
      <h3 className="text-lg font-medium mb-2">Examples:</h3>
      <ul className="list-disc list-inside mb-4">
        <li>
          <strong>Route Finding Problem:</strong> The map shown in Fig. 2.2 corresponds to a graph, where the nodes are
          assumed as cities and the links between nodes represent the routes between cities. The problem is to find a
          route in the graph from city S to city T.
        </li>
        <li>
          <strong>Eight Puzzle Problem:</strong> A 3x3 board is given that contains 8 tiles (each tile containing a
          number ranging from 1 to 8) and one empty space. The goal is to place the numbers on tiles in a specific
          ordering that matches the final configuration using the empty space. However, only one tile can be moved at a
          time, and only four types of slides are allowed (left, right, above, and below).
        </li>
      </ul>
...
<p className='text-xl'>Solution:</p>
      <p className="mb-4 font-semibold">Total possible casual dresses = (number of shirts) x (number of pants).</p>
      ...
      <ul className="list-disc pl-6">
        <li>Define and analyze a problem: What is the problem and why it is happening.</li>
      ...
      <ul className="list-disc pl-6">
        ...
        <li>Identify potential plans for each sub-problem: such as plan A, plan B and plan C</li>
