...
const data = [
  {
    ...
    links: [
      ...
      {
        href: "/strengthening-of-the-faith/the-definations-of-islam",
        text: "The acts leading to polytheism",
        icon: BookOpen,
      },
      {
        href: "/strengthening-of-the-faith/islamic-faith-and-infidelity",
        text: "Those who profess to have Faith in Allah while their actions reeking of polytheism",
        icon: HelpCircle,
      },
      {
        href: "/strengthening-of-the-faith/about-paradise",
        text: "The verdict of Qur'an",
        icon: Brain,
      },
      {
        href: "/strengthening-of-the-faith/about-hell",
        text: "None but Allah is the Capable",
        icon: FileText,
      },
      {
        href: "/strengthening-of-the-faith/the-impeccable-life-of-allah-beloved-prophet",
        text: "None is the supporter other than Allah",
        icon: Brain,
      },
      {
        href: "/strengthening-of-the-faith/about-the-holy-quran",
        text: "None is the sustainer other than Allah",
        icon: Brain,
      },
      {
        href: "/strengthening-of-the-faith/excellence-of-salaat",
