            ...
            <div className="mt-12 border-t pt-8">
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl">
                ...
                <div className="ml-6 mb-6">
                  <p className="text-gray-700">1. Al (atomic number=13)</p>
                  <p className="text-gray-700">2. K (atomic number = 19)</p>
                </div>
              ...
              <div className="mt-12 border-t pt-8">
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl">
                  ...
                  <div className="bg-white p-4 rounded-lg mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-gray-700">A. 1s² 2s²</p>
                        <p className="text-gray-700">B. 1s² 2s² 2p³</p>
                        <p className="text-gray-700">C. 1s² 2s² 2p⁵</p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-gray-700">D. 1s² 2s² 2p⁶ 3s²</p>
                        <p className="text-gray-700">E. 1s² 2s² 2p⁶ 3s² 3p⁵</p>
                        <p className="text-gray-700">F. 1s² 2s² 2p⁶ 3s² 3p¹</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-lg mb-6">
                    ...
                    <p className="text-gray-700 mb-2">Remember that:</p>
                    <div className="ml-4 space-y-2">
                      <p className="text-gray-700">
