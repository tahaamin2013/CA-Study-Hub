...
const QuestionsPage = () => {
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold mb-4">Short Response Questions</h1>
      <ol className="list-decimal list-inside space-y-4">
        <li>Differentiate between forward and reverse reactions.</li>
        <li>What is chemical equilibrium?</li>
        <li>Write two chemical equations of reversible reactions.</li>
        <li>Coal reacts with hot steam to form CO and H2. These substances react further in the presence of a catalyst to give methane and water vapor.</li>
        ...
        <li>Sugar readily dissolves in water. Is this a reversible reaction? How can we identify the reactants and products in this process?</li>
        <li>How reversible reactions may not go to completion. Provide an example to illustrate this idea.</li>
        <li>How does increasing the temperature affect the position of equilibrium for an exothermic reversible reaction?</li>
        <li>What happens to the equilibrium position when a reactant is added to a system at equilibrium?</li>
        <li>Describe the effect of pressure increase on the equilibrium of a gaseous reversible reaction involving unequal moles of gas on either side.</li>
        <li>How does the addition of water affect the equilibrium of an anhydrous compound like copper(II) sulfate?</li>
        <li>Why might cooling a system containing a hydrated compound shift the equilibrium?</li>
        <li>In a closed system at equilibrium, what is the effect of removing one of the products from the reaction mixture?</li>
      </ol>
    </div>
  );
};
