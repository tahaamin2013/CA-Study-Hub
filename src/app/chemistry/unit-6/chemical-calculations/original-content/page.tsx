export default function ChemicalCalculations() {
    return (
        <div className="p-4">
            ...
            <h4 className="text-md font-medium mb-2">Example 6.3: Calculating mass of one mole of a substance</h4>
            <p className="mb-2">
                ...
                (b) Nitrogen
                <br />
                (c) Sucrose C<sub>12</sub>H<sub>22</sub>O<sub>11</sub>
            </p>
            <p className="mb-2">
...
moles of ozone is formed in a storm?
            ...
            <h4 className="text-md font-medium mb-2">Example 6.7: Calculating the number of atoms in given moles</h4>
            <p className="mb-2">
